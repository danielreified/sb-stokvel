...
/**
 * Idle-lock screen rendered inside the AppWindow's panel slot when the
 * inactivity threshold is exceeded. Session is still valid server-side; this
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-6 bg-background p-8 text-center">
      ...
      <div className="space-y-1.5">
        ...
        <h1 className="text-2xl font-semibold">{copy.pinLock.welcome.replace('{name}', name)}</h1>
