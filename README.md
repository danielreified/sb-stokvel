...
The full design notes, architectural decisions, threat model, deployment
docs, and engineering principles will land tomorrow. Until then, the
codebase itself + commit messages on `main` are the source of truth.
